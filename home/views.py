...
def template_example(request):
    ...
    empty_list =[]
    return render(request, 'template_example.html',{'my_list':my_list, 'my_dict':my_dict, 'my_sentence':my_sentence, 'messages':messages, 'datetimenow':datetimenow ,'empty_list':empty_list})
